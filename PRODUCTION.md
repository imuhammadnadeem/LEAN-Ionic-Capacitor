...
2. **Android** – From repo root: `cd android && ./gradlew assembleRelease`. In your **app**, add JitPack and `implementation "me.leantech:link-sdk-android:3.0.2"`.
3. **iOS** – Host app adds Lean SDK in Xcode via SPM: File → Add Package Dependencies → `https://github.com/leantechnologies/link-sdk-ios-distribution`.
